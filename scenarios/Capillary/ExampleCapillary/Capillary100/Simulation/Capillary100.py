...
def configure_simulation(SimID, NO, xdim, ydim, Temp, J10, J11, J12, steps):
    ...
    SteppableElmnt.ElementCC3D("PIFName",{},"Simulation/Capillary100.piff")
...
from Capillary100Steppables import GrowthSteppable
CompuCellSetup.register_steppable(steppable=GrowthSteppable(lambda_v, lambda_s, A_i, sigma, epsilon_P, GT, GF, dt, frequency=1))

from Capillary100Steppables import MitosisSteppable
CompuCellSetup.register_steppable(steppable=MitosisSteppable(A_i, sigma, epsilon_P, frequency=1))

from Capillary100Steppables import TissueTrackerSteppable
CompuCellSetup.register_steppable(steppable=TissueTrackerSteppable(SimID, frequency=1000))

from Capillary100Steppables import CellTrackerSteppable
CompuCellSetup.register_steppable(steppable=CellTrackerSteppable(SimID, frequency=1000))

from Capillary100Steppables import MacroscopicVolumeTrackerSteppable
