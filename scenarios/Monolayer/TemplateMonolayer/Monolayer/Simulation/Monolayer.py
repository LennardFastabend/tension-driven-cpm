...
def configure_simulation(SimID, NO, xdim, ydim, Temp, J10, J11, J12, steps):
    ...
    SteppableElmnt.ElementCC3D("PIFName",{},"Simulation/MonolayerSubstrate.piff")
